...
# saveFreq (number of epochs between saves), loadNewData (set to false if no numpy file exists)
def train(noiseShape, imageShape, epochs, batchSize, learningRate, saveFreq, inputPath, loadNewData):
